      ...
      <section className="py-14 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[{
              name: "Ирина и Андрей",
              role: "2 детей, Санкт‑Петербург",
              quote: "Перестали спорить из‑за покупок, а дети сами отмечают, что куплено. Вечером — больше сил друг на друга.",
              img: "https://images.unsplash.com/photo-1520813792240-56fc4a3765a7?q=80&w=800&auto=format&fit=crop",
            },{
              name: "Наташа",
              role: "мама‑предприниматель",
              quote: "Утренний дайджест — спасение. Я вижу, кто что делает, без лишних слов. Стало спокойнее.",
              img: "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?q=80&w=800&auto=format&fit=crop",
            },{
              name: "Алексей",
              role: "папа‑айтишник",
              quote: "Поддержка часовых поясов супер — я в командировке, а семья не выпадает из контекста.",
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <Accordion type="single" collapsible className="rounded-3xl bg-white border border-rose-100 p-4 sm:p-6">
            <AccordionItem value="item-1">
              <AccordionTrigger>Нужно ли устанавливать приложение?</AccordionTrigger>
              <AccordionContent>
                Нет, Homi работает прямо в Telegram — привычно и быстро.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-2">
              <AccordionTrigger>Homi видит наши личные переписки?</AccordionTrigger>
              <AccordionContent>
                Нет. Бот обрабатывает только сообщения, которые вы отправляете ему. Приватные чаты и другие каналы недоступны.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-3">
              <AccordionTrigger>А если у нас разные часовые пояса?</AccordionTrigger>
              <AccordionContent>
                У каждого пользователя своя тайм‑зона, напоминания приходят в удобное локальное время.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-4">
              <AccordionTrigger>Это платно?</AccordionTrigger>
              <AccordionContent>
                На старте — бесплатно. Позже появятся расширенные функции с недорогой подпиской.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
